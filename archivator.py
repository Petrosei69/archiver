...
label = tk.Label(root, text=" Чтобы архивировать любой другой файл, нужно нажать кнопку 1 и выбрать файл в всплывающем окне\n\n"
                            " Чтобы архивировать все папки внутри директории проекта, нужно нажать кнопку 2\n\n"
                            " Чтобы архивировать эти файлы на выбор предоставлены последние 3 кнопки\n")
